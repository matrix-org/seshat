...
const exampleEvents = [{ event: matrixEvent, profile: matrixProfileOnlyDisplayName }];
...
describe("Database", function () {
  ...
  it("should add messages to an encrypted db and correctly report if they are already added", async function () {
    ...
    const events = [{ event: messageEvent, profile: matrixProfileOnlyDisplayName }];
  ...
  it("should allow us to delete the db", async function () {
    ...
    expect(() => db.addEvent(matrixEvent, matrixProfileOnlyDisplayName)).toThrow(
      TypeError("Database has been closed or deleted"),
    );
  });
